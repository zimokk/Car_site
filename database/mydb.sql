...
--
-- Хост: 127.0.0.1
-- Время создания: Май 19 2016 г., 14:03
...
INSERT INTO `cars` (`idCars`, `mark_id`, `model_id`, `cost`, `year`, `fuel`, `transmission`, `body_id`, `user_id`, `city_id`) VALUES
(2, 4, 4, '100000', 2010, 1, 0, 1, 1, 1),
(5, 2, 2, '200000', 2012, 2, 0, 9, 2, 1),
(6, 3, 3, '300000', 2016, 2, 0, 9, 2, 1);
